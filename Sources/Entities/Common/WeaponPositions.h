...
wpn_fZ[29]=(FLOAT)0;
wpn_fZ[30]=(FLOAT)0;
wpn_fFOV[0]= 75;//2 * 1.18f;
wpn_fFOV[1]= 75;//41.5 * 1.18f;
wpn_fFOV[2]= 75;//57 * 1.18f;
wpn_fFOV[3]= 75;//57 * 1.18f;
wpn_fFOV[4]= 75;//41 * 1.18f;
wpn_fFOV[5]= 75;//52.5 * 1.18f;
wpn_fFOV[6]= 75;//(FLOAT)49 * 1.18f;
wpn_fFOV[7]= 75;//(FLOAT)66.9 * 1.18f;
wpn_fFOV[8]= 75;//(FLOAT)66 * 1.18f;
wpn_fFOV[9]= 75;//(FLOAT)85.5 * 1.18f;
wpn_fFOV[10]= 75;//(FLOAT)72 * 1.18f;
wpn_fFOV[11]= 75;//(FLOAT)80 * 1.18f;
wpn_fFOV[12]= 75;//(FLOAT)50 * 1.18f;
wpn_fFOV[13]= 75;//(FLOAT)80 * 1.18f;
wpn_fFOV[14]= 75;//(FLOAT)70.5 * 1.18f;
wpn_fFOV[15]= 75;//(FLOAT)52.5 * 1.18f;
wpn_fFOV[16]= 75;//(FLOAT)50 * 1.18f;
wpn_fFOV[17]=(FLOAT)0;
wpn_fFOV[18]=(FLOAT)0;
wpn_fFOV[19]=(FLOAT)0;
wpn_fFOV[20]=(FLOAT)0;
...
wpn_fY[9]=(FLOAT)-0.45;
wpn_fZ[9]=(FLOAT)-0.2;
wpn_fFOV[9]= 75;//(FLOAT)44.5 * 1.18f;
