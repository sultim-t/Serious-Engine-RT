...
wpn_fZ[29]=(FLOAT)0;
wpn_fZ[30]=(FLOAT)0;
wpn_fFOV[0]=(FLOAT)2 * 1.18f;
wpn_fFOV[1]=(FLOAT)41.5 * 1.18f;
wpn_fFOV[2]=(FLOAT)57 * 1.18f;
wpn_fFOV[3]=(FLOAT)57 * 1.18f;
wpn_fFOV[4]=(FLOAT)41 * 1.18f;
wpn_fFOV[5]=(FLOAT)52.5 * 1.18f;
wpn_fFOV[6]=(FLOAT)49 * 1.18f;
wpn_fFOV[7]=(FLOAT)66.9 * 1.18f;
wpn_fFOV[8]=(FLOAT)66 * 1.18f;
wpn_fFOV[9]=(FLOAT)44.5 * 1.18f;
wpn_fFOV[10]=(FLOAT)73.5 * 1.18f;
wpn_fFOV[11]=(FLOAT)50 * 1.18f;
wpn_fFOV[12]=(FLOAT)70.5 * 1.18f;
wpn_fFOV[13]=(FLOAT)23 * 1.18f;
wpn_fFOV[14]=(FLOAT)50 * 1.18f;
